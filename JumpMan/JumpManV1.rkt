...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname JumpManV1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)
...
(define JUMP-START 30) ; initial upward force
